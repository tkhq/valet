...
// question answered:
//
//   • Arming paths (POST /api/code-review/enable, POST /api/templates/:id/
//     enable-app, the github-app branch of POST/PATCH /api/triggers) prove it
//     before the trigger exists, so a
