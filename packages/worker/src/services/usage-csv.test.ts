...
const report: UsageStatsResponse = {
  ...
  byWorkflow: [],
  period: 0,
  report: { scope: 'org', periodType: 'month', start: '2024-02-01T00:00:00.000Z', end: '2024-03-01T00:00:00.000Z', label: 'calendar-month_2024-02_UTC', timezone: 'UTC', boundary: 'start-inclusive/end-exclusive', sandboxUsage: 'recorded-intervals-with-legacy-session-start-attribution' },
};
