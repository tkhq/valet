...
const SCHEMA_REPAIRS: SchemaRepair[] = [
  { describe: "agent_sessions.git_attribution_snapshot_pending column", probe: { kind: "column", table: "agent_sessions", column: "git_attribution_snapshot_pending" }, sql: 'ALTER TABLE "agent_sessions" ADD COLUMN IF NOT EXISTS "git_attribution_snapshot_pending" boolean DEFAULT false NOT NULL' },
  { describe: "orgs.git_attribution_settings column", probe: { kind: "column", table: "orgs", column: "git_attribution_settings" }, sql: 'ALTER TABLE "orgs" ADD COLUMN IF NOT EXISTS "git_attribution_settings" jsonb' },
  { describe: "user.git_attribution_settings column", probe: { kind: "column", table: "user", column: "git_attribution_settings" }, sql: 'ALTER TABLE "user" ADD COLUMN IF NOT EXISTS "git_attribution_settings" jsonb' },
  { describe: "teams.git_attribution_settings column", probe: { kind: "column", table: "teams", column: "git_attribution_settings" }, sql: 'ALTER TABLE "teams" ADD COLUMN IF NOT EXISTS "git_attribution_settings" jsonb' },
  { describe: "session git attribution snapshots", probe: { kind: "table", table: "session_git_attribution_snapshots" }, sql: 'CREATE TABLE IF NOT EXISTS "session_git_attribution_snapshots" ("session_id" text NOT NULL, "generation" integer NOT NULL, "mode" text NOT NULL, "co_authored_by" boolean NOT NULL, "correlation_trailers" boolean NOT NULL, "owner_type" text NOT NULL, "owner_id" text NOT NULL, "counterpart_user_id" text, "counterpart_name" text, "counterpart_email" text, "valet_name" text NOT NULL, "valet_email" text NOT NULL, "settings_fingerprint" text NOT NULL, "created_by" text NOT NULL, "created_at" bigint NOT NULL, PRIMARY KEY("session_id", "generation"))' },
  { describe: "session git attribution heads", probe: { kind: "table", table: "session_git_attribution_heads" }, sql: 'CREATE TABLE IF NOT EXISTS "session_git_attribution_heads" ("session_id" text PRIMARY KEY NOT NULL, "active_generation" integer NOT NULL, "updated_at" bigint NOT NULL)' },
  { describe: "git push operations", probe: { kind: "table", table: "git_push_operations" }, sql: 'CREATE TABLE IF NOT EXISTS "git_push_operations" ("id" text PRIMARY KEY NOT NULL, "session_id" text NOT NULL, "generation" integer NOT NULL, "repo_full_name" text NOT NULL, "target_ref" text NOT NULL, "expected_remote_sha" text NOT NULL, "local_head_sha" text NOT NULL, "signed_head_sha" text, "state" text NOT NULL, "error_code" text, "created_at" bigint NOT NULL, "updated_at" bigint NOT NULL)' },
  { describe: "git push operations identity", probe: { kind: "index", index: "git_push_operations_identity" }, sql: 'CREATE UNIQUE INDEX IF NOT EXISTS "git_push_operations_identity" ON "git_push_operations" ("session_id","generation","repo_full_name","target_ref","local_head_sha")' },
  { describe: "git push commit map", probe: { kind: "table", table: "git_push_commit_map" }, sql: 'CREATE TABLE IF NOT EXISTS "git_push_commit_map" ("operation_id" text NOT NULL, "local_sha" text NOT NULL, "signed_sha" text NOT NULL, "tree_sha" text NOT NULL, "verification_json" jsonb NOT NULL, "created_at" bigint NOT NULL, PRIMARY KEY("operation_id", "local_sha"))' },
  { describe: "session git branches", probe: { kind: "table", table: "session_git_branches" }, sql: 'CREATE TABLE IF NOT EXISTS "session_git_branches" ("session_id" text NOT NULL, "generation" integer NOT NULL, "repo_full_name" text NOT NULL, "ref" text NOT NULL, "head_sha" text NOT NULL, "push_operation_id" text, "observed_at" bigint NOT NULL, PRIMARY KEY("session_id", "repo_full_name", "ref"))' },
  { describe: "session pull requests", probe: { kind: "table", table: "session_pull_requests" }, sql: 'CREATE TABLE IF NOT EXISTS "session_pull_requests" ("session_id" text NOT NULL, "repo_full_name" text NOT NULL, "pr_number" integer NOT NULL, "pr_url" text NOT NULL, "head_ref" text NOT NULL, "head_sha" text NOT NULL, "base_ref" text NOT NULL, "state" text NOT NULL, "first_observed_at" bigint NOT NULL, "updated_at" bigint NOT NULL)' },
  { describe: "session pull requests identity", probe: { kind: "index", index: "session_pull_requests_identity" }, sql: 'CREATE UNIQUE INDEX IF NOT EXISTS "session_pull_requests_identity" ON "session_pull_requests" ("repo_full_name","pr_number","session_id")' },
  {
