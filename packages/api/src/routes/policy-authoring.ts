...
import { CanonicalPolicyConfigManagedError, CanonicalPolicyDelegatedRulesDroppedError, CanonicalPolicySourceReadOnlyError } from "../authorization/canonical-policy-manager.js";
...
policyAuthoringRouter.onError((error, c) => {
  if (error instanceof PolicyAuthoringError || error instanceof CanonicalPolicyConfigManagedError || error instanceof CanonicalPolicyDelegatedRulesDroppedError || error instanceof CanonicalPolicySourceReadOnlyError)
