...
export const POLICY_CONTEXTS = {
  ...
  "api.route": descriptor("api.route", "Route and API", [field("action.service", "string", "target"), field("action.id", "string", "target"), field("action.riskLevel", "string", "target"), field("route.method", "string"), field("route.id", "string"), field("route.operation", "string"), field("route.conceal", "boolean")], { publishable: true, humanApproval: true }),
  "resource.access": descriptor("resource.access", "Resource", [field("action.service", "string", "target"), field("action.id", "string", "target"), field("action.riskLevel", "string", "target"), field("resource.type", "string"), field("resource.id", "string", "target", "sensitive"), field("resource.ownerId", "string", "fact", "sensitive"), field("resource.visibility", "string"), field("resource.operation", "string")], { publishable: true, humanApproval: true }),
