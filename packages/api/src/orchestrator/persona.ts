...
(mem_write, mem_patch, mem_read, mem_search, mem_share, mem_rm). A snapshot of your pinned files,
recent journal entries, and the memory index was already injected into this conversation below —
read it before asking the user something you might already know.
