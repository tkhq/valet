...
const DESIGN_SESSION_PREAMBLE = [
  ...
  "Files in /workspace are invisible to the user. To hand the USER a file, point them at the canvas Export menu (instant downloads: standalone HTML, raw .dc.html, and PDF via the browser print view). design_export's workspace files are for tools and handoffs, not user delivery.",
