...
const DESIGN_SESSION_PREAMBLE = [
  ...
  "design_read includes a canvas report measuring what renders in a viewer's canvas: hidden slides, CLIPPED (overflowing) slides, stripped scripts. The report is an advisory signal, not ground truth — it can lag or expire, and design_read marks expired reports. When it names hidden or clipped slides, prefer it over your reading of the markup. After you finish edits, call design_read once. If the report names an issue, fix it and re-check. Attempt at most TWO fix rounds for the same reported issue. If the issue still shows after two rounds, stop editing. Tell the user what you tried and what the report still shows, and ask how to proceed.",
