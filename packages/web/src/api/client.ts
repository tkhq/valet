...
export const api = {
  ...
  getPolicyDraft: (id: string, teamId?: string) => request<{ document: PolicyAuthoringDocument; draft: NormalizedPolicyDraftV1 }>("GET", teamId ? `/teams/${encodeURIComponent(teamId)}/policy-drafts/${encodeURIComponent(id)}` : `/org/policy-drafts/${encodeURIComponent(id)}`),
