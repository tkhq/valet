      ...
      services: [
        {
          ...
          connect: "oauth",
          actions: [
            { id: "github.create_issue", name: "Create issue", riskLevel: "medium", requiresApproval: false },
            { id: "github.delete_repo", name: "Delete repo", riskLevel: "critical", requiresApproval: true },
          ],
        },
      ],
    },
      ...
      services: [
        {
          ...
          connected: false,
          connect: "oauth",
          actions: [{ id: "linear.create_issue", name: "Create issue", riskLevel: "low", requiresApproval: false }],
        },
      ],
    },
  ],
