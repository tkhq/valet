...
beforeEach(() => {
  vi.clearAllMocks();
  meData = { id: "u1", email: "a@b.com", name: "A", avatarUrl: null, role: "member", orgId: "org_1", orgRole: "member", defaultModel: null, defaultReasoning: null };
});
...
describe("DecisionGateCard — always_allow admin gate", () => {
  ...
  it("enables Always allow for an org admin and submits actionId on click", async () => {
    meData = { id: "u1", email: "a@b.com", name: "A", avatarUrl: null, role: "member", orgId: "org_1", orgRole: "admin", defaultModel: null, defaultReasoning: null };
    const user = userEvent.setup();
    renderCard();
