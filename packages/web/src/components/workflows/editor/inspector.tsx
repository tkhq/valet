...
export function Inspector({ node, onChange, onRemove, onDuplicate, readOnly = false }: InspectorProps) {
  return (
    <fieldset disabled={readOnly} className="flex h-full min-w-0 flex-col" data-testid="inspector">
