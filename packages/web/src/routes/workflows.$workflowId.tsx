...
function WorkflowEditorPane({
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0">
      <div className="flex flex-col gap-2 border-b border-line px-4 py-3 sm:px-6 lg:flex-row lg:items-center lg:justify-between">
