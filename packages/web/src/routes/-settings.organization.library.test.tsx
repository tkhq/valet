...
describe("OrganizationLibraryPage — org skills panel", () => {
  beforeEach(() => {
    orgData = { id: "org_1", name: "Acme", createdAt: 0, callerRole: "admin", features: { organizations: true, ssoTeamSync: false }, ssoTeamGroups: [], allowPublicArtifacts: false, plugins: [] };
