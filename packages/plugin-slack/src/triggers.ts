/**
 * Slack TriggerDefs — webhook events normalized into the generic event
 * pipeline (spec: docs/specs/2026-07-21-slack-channel-events-design.md,
 * decision 7). `verify` implements the full signing-secret HMAC even though
 * the dedicated api route short-circuits with pre-verified events.
 *
