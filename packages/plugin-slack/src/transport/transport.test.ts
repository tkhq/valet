...
describe("gate prompt identity", () => {
  it("keeps the installed bot identity for approval cards", async () => {
    const transport = makeTransport();
    await transport.sendGatePrompt(KEY, {
...
describe("discrete sends", () => {
  ...
  it("keeps the installed bot identity for discrete messages", async () => {
    const transport = makeTransport();
