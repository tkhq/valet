...
function validate(spec, data) {
  ...
  const groups = ["capabilityVectors", "mapVectors", "cgroupVectors", "startupVectors", "leaderStateVectors", "startRecoveryVectors", "lifecycleVectors", "statusVectors", "acceptanceVectors"];
