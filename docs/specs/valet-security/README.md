...
| [Part 10: Per-Engagement Credential Vault](spec/10-credential-vault.md) | Fluid credential ingress (seven-variant union), owner-scoped encrypted-at-rest storage, credsMount delivery, three-seam tripwire, TTL crypto-shred, owner-only visibility. Closes the plaintext leak on the needs-answer path. |
