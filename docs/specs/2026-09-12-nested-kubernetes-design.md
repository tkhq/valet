...
The Helper MUST retry an EACCES or EPERM Root deletion through /usr/bin/rootlesskit with only the K109 subordinate maps and the exact Root target. [K189]
...
The retry uses a temporary 0700 runtime directory and removes it after RootlessKit exits.
