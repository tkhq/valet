...
The API uses the larger reserve. At or below the reserve, new bakes and sandbox-backed children fail before creation.
A configured probe that fails also blocks admission. An unset probe reports unknown capacity without blocking admission.
